...
_DESCRIPTION = (
    ...
    "relevant to a query iff it contains the annotated answer moment. This is the "
    "full-video counterpart of the chunk-based MomentSeeker tasks. "
)


def _load_momentseeker_full(task: AbsTaskRetrieval, direction: str) -> None:
...
class MomentSeekerTI2VFullRetrieval(AbsTaskRetrieval):
    metadata = TaskMetadata(
        name="MomentSeekerTI2VFullRetrieval",
    ...
    def load_data(self, num_proc: int | None = None, **kwargs) -> None:
        _load_momentseeker_full(self, "ti2v")


class MomentSeekerTV2VFullRetrieval(AbsTaskRetrieval):
    metadata = TaskMetadata(
        name="MomentSeekerTV2VFullRetrieval",
        description=_DESCRIPTION
    ...
    def load_data(self, num_proc: int | None = None, **kwargs) -> None:
        _load_momentseeker_full(self, "tv2v")
